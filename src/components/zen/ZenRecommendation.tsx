        ...
        <div className="grid grid-cols-1 gap-2 sm:grid-cols-3">
          {data.recommendations.map((rec, i) => (
            <button
              ...
              className={cn(
                'text-left p-3 rounded-zen-lg border border-zen-border-soft bg-zen-primary-soft/40',
            ...
            >
              ...
              <p className="text-sm font-semibold text-zen-fg">{rec.name}</p>
